...
Based on the large number of responses, the Ministry of Transport and Communications removed the domain name registrar change from the regulation, and plans to reassess the matter. [^3]
...
You just fill out the application form on Traficom's website [^5]. I filled it out as a private individual, and I marked that the service I offer is `Verkkotunnusten hallinnointi ilman muita palveluita`
